...
- Vision for person segmentation, clothing foreground extraction, and future human body pose detection if a later avatar-quality pass needs it.
...
- Vision, Core ML, and Core Image are the preferred first choices for avatar, clothing foreground extraction, future body-pose work, and image-compositing because they keep sensitive body and wardrobe imagery on-device where feasible.
