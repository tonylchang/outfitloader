...
### User Onboarding & Avatar Creation

- Guided full-body selfie capture with framing and lighting guidance.
- Avatar generation from the user's selfie into a recognizable digital representation.
- Basic avatar customization, such as height and body-shape adjustments, to improve accuracy when the source photo is imperfect.
...
- Advanced wardrobe analytics such as cost per wear or detailed usage statistics.

## Out of Scope

- Android app support for the initial product.
- Automatic clothing categorization unless explicitly added to the spec later.
- Full-featured AI styling, social, retail, or analytics systems in the first usable release.
